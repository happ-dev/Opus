 ...
 * @Date:   2026-02-03 12:20:19
 * @Last Modified by:   Tomasz Ułazowski
 * @Last Modified time: 2026-02-07 17:00:36
 **/

namespace Opus\storage\exception;

use Opus\controller\exception\AbstractException;
...
class StorageException extends AbstractException
{
	...
	public function __construct(
		...
		?array $value,
		public readonly string $type = self::TYPE_API_EXCEPTION,
		?string $file = null
	) {
