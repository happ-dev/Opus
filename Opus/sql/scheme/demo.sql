...
INSERT INTO demo.payroll (firstname, lastname, department, position, salary, contract, active, hire_date) VALUES
	...
	('Monika',    'Szymczak',    2, 'HR Specialist',         8800.00, 1, TRUE,  '2022-04-11'),
	('Rafał',     'Kozłowski',   1, 'Backend Developer',    11200.00, 1, TRUE,  '2021-11-03'),
	('Agnieszka', 'Jankowska',   4, 'Content Manager',       8200.00, 2, TRUE,  '2023-01-16'),
	('Michał',    'Mazur',       5, 'Logistics Coordinator', 9000.00, 1, TRUE,  '2022-08-20'),
	('Magdalena', 'Krawczyk',    3, 'Senior Accountant',    10800.00, 1, TRUE,  '2020-05-12'),
	('Krzysztof', 'Piotrowski',  1, 'Frontend Developer',   10500.00, 1, TRUE,  '2022-03-07'),
	('Aleksandra','Grabowska',   2, 'Recruiter',             7800.00, 3, TRUE,  '2023-09-01'),
	('Jakub',     'Pawlak',      5, 'Warehouse Manager',     9500.00, 1, TRUE,  '2021-06-18'),
	('Natalia',   'Michalska',   4, 'Social Media Specialist',7600.00, 2, TRUE,  '2023-04-22'),
	('Paweł',     'Zając',       1, 'QA Engineer',           9800.00, 1, TRUE,  '2022-10-09'),
	('Karolina',  'Król',        3, 'Payroll Specialist',    8900.00, 1, TRUE,  '2021-12-01'),
	('Marcin',    'Wójcicki',    5, 'Fleet Manager',         9300.00, 2, FALSE, '2020-09-15'),
	('Izabela',   'Stefańska',   2, 'Training Coordinator',  8400.00, 1, TRUE,  '2023-02-28'),
	('Damian',    'Wróblewski',  1, 'System Administrator', 11800.00, 1, TRUE,  '2021-01-10'),
	('Paulina',   'Sikora',      4, 'Brand Manager',        10100.00, 1, TRUE,  '2022-06-14'),
	('Grzegorz',  'Błaszczyk',   3, 'Tax Advisor',          11500.00, 3, TRUE,  '2019-11-20'),
	('Łukasz',    'Olszewski',   5, 'Supply Chain Analyst',  9100.00, 1, TRUE,  '2023-07-03'),
	('Dorota',    'Rutkowska',   1, 'Scrum Master',         12000.00, 1, TRUE,  '2020-04-06'),
	('Sebastian', 'Jaworski',    4, 'SEO Specialist',        8000.00, 2, TRUE,  '2023-05-19'),
	('Weronika',  'Adamczyk',    2, 'Compensation Analyst',  9600.00, 1, TRUE,  '2022-09-25');
